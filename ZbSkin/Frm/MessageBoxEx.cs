...
namespace ZbSkin.Frm
{
    public partial class MessageBoxEx : SkinForm
    {
        ...
        private void MessageBoxEx_Load(object sender, EventArgs e)
        {
            ...
            FontManager.Instance.InitControlFont(label_icon, FontManager.IconFont, NotifyIconTitle, 20);
            FontManager.Instance.InitControlFont(label_image, FontManager.IconFont, label_image.Text, _labelImgFont);
