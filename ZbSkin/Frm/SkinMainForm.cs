...
namespace ZbSkin.Frm
{
    public partial class SkinMainForm : Form
    {
        ...
        private void ChangeSkin(string skinName)
        {
            ...
            {
                case "next_gen": //次世代
                    bmp = CommonPara.ImageNextGen;
                    break;
                case "festival_red": //喜庆红
                    bmp = CommonPara.ImageFestivalRed;
                    break;
                case "eye_green": //护眼绿
                    bmp = CommonPara.ImageEyeGreen;
                    break;
                case "grass": //青草地
                    bmp = CommonPara.ImageGrass;
                    break;
                case "state_grid": //国网绿
                    bmp = CommonPara.ImageStateGrid;
                    break;
                case "peacock_blue": //孔雀蓝
                    bmp = CommonPara.ImagePeacockBlue;
                    break;
                default:
                    return;
            }
